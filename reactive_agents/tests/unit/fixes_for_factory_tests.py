"""
Fixes for the ReactAgentBuilder factory method tests.
...
from reactive_agents.agents.builders import ReactAgentBuilder
...
async def test_research_agent_factory_fixed():
    ...
    with patch.object(ReactAgentBuilder, "build") as mock_build:
...
async def test_quick_create_agent_fixed_v2():
    ...
    builder = MagicMock(spec=ReactAgentBuilder)
    ...
    # Patch the ReactAgentBuilder constructor to return our mock builder
    with patch(
        "reactive_agents.agents.builders.ReactAgentBuilder", return_value=builder
    ):
        # Import here to avoid circular imports
        from reactive_agents.agents.builders import quick_create_agent
